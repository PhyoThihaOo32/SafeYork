  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        {/* Constellation star field GIF — base layer */}
        <div
          className="absolute inset-0 bg-cover bg-center opacity-60"
          style={{ backgroundImage: `url(${CONSTELLATION_GIF})` }}
        />
        {/* Neon network GIF — blended overlay */}
        <div
          className="absolute inset-0 bg-cover bg-center mix-blend-screen opacity-25"
          style={{ backgroundImage: `url(${NEON_NETWORK_GIF})` }}
        />
        {/* Dark vignette to keep text readable */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_30%,oklch(0.1_0.02_260)_100%)]" />
